...
<link
	href="${pageContext.request.contextPath}/styles/label.css"
	rel="stylesheet">
	
<link 
	href="${pageContext.request.contextPath}/styles/button.css"
	rel="stylesheet">
...
<body> b
	...
	<div id="inputArea" style="margin-left: 30px; margin-top: 30px;">
		...
		<label>明文: </label>
		<input type="text" id="inputString" name="inputString" value="" style="margin-right: 30px;" />
		
		<label>密文： </label>
		<input type="text" id="outputString" name="outputString" value="" style="width: 500px; margin-right: 30px;" />
		
		<label>密文长: </label>
		<input type="text" id="outputStringLength" name="outputStringLength" value="" style="width: 40px; margin-right: 30px;" />
	...
	<div id="searchAll" style="margin-top: 30px; margin-left: 30px;">
		...
		<label>算法名称:  </label>
		<input type="text" id="algorithmName" style="width: 100px; margin-right: 50px;" value="" name="algorithmName" />
